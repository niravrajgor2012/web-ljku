...
export interface ApiAdmissionAdmission extends Schema.CollectionType {
  ...
  info: {
    ...
    description: 'Admission information and deadlines';
  };
  options: {
...
export interface ApiDepartmentDepartment extends Schema.CollectionType {
  ...
  info: {
    ...
    description: 'University departments and schools';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    established: Attribute.String;
    totalStudents: Attribute.Integer;
    totalFaculty: Attribute.Integer;
...
export interface ApiFacultyFaculty extends Schema.CollectionType {
  ...
  attributes: {
    ...
    publications: Attribute.Integer;
    isFeatured: Attribute.Boolean & Attribute.DefaultTo<false>;
...
export interface ApiGalleryGallery extends Schema.CollectionType {
  ...
  info: {
    ...
    displayName: 'Gallery';
    description: 'University photo gallery';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiNewsNews extends Schema.CollectionType {
  ...
  info: {
    ...
    displayName: 'News';
    description: 'University news articles';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPlacementPlacement extends Schema.CollectionType {
  ...
  info: {
    ...
    description: 'Placement records and success stories';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    isFeatured: Attribute.Boolean & Attribute.DefaultTo<false>;
    category: Attribute.Enumeration<
      ['Campus', 'Off-Campus', 'Higher-Studies', 'Entrepreneurship']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiProgramProgram extends Schema.CollectionType {
  ...
  attributes: {
    ...
    degreeType: Attribute.Enumeration<
      [
        'B.Tech',
        'M.Tech',
        'BBA',
